              ...
              <div class="xs-donation-form-wraper">
                ...
                "xs-donation-form" name="xs-donation-form">
                  <div class="xs-input-group">
                    ...
                    "color-light-red">**</span></label> <input type="text" name="name" id="xs-donate-name" class="form-control" placeholder="Minimum of $5">
                  ...
                  <div class="xs-input-group">
                    <label for="xs-donate-email">Your Email</label>
                    <input
                      required
                      type="email"
                      name="email"
